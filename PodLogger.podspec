...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/luokairui/PodLogger'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'luokairui' => 'arerui@126.com' }
  s.source           = { :git => 'https://github.com/luokairui/PodLogger.git', :tag => s.version.to_s }
